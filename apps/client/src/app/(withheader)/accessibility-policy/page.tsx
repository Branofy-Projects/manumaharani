            ...
            <div className="mx-auto max-w-screen-xl px-4 py-10 md:py-16">
                <div className="prose prose-gray max-w-none">
                    <section className="mb-10">
                        <h2 className="mb-4 font-thin tracking-widest text-xl uppercase text-[#2b2b2b]">Our Commitment</h2>
                    ...
                    <section className="mb-10">
                        <h2 className="mb-4 font-thin tracking-widest text-xl uppercase text-[#2b2b2b]">Web Accessibility</h2>
                        <p className="font-serif text-base leading-relaxed text-[#5a5a5a] md:text-lg">
                    ...
                    <section className="mb-10">
                        <h2 className="mb-4 font-thin tracking-widest text-xl uppercase text-[#2b2b2b]">On-Property Accessibility</h2>
                    ...
                    <section className="mb-10">
                        <h2 className="mb-4 font-thin tracking-widest text-xl uppercase text-[#2b2b2b]">Ongoing Efforts</h2>
                        <p className="font-serif text-base leading-relaxed text-[#5a5a5a] md:text-lg">
                    ...
                    <section>
                        <h2 className="mb-4 font-thin tracking-widest text-xl uppercase text-[#2b2b2b]">Feedback</h2>
                        <p className="font-serif text-base leading-relaxed text-[#5a5a5a] md:text-lg">
