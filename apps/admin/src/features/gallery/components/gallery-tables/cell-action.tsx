...
import { deleteGallery } from '@repo/actions';
...
export const CellAction: React.FC<CellActionProps> = ({ data }) => {
  ...
  const onConfirm = async () => {
    if (!confirm(`Are you sure you want to delete "${data.title || 'this item'}"?`)) {
      return;
    }
  ...
  return (
    <DropdownMenu modal={false}>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem onClick={() => router.push(`/gallery/${data.id}/edit`)}>
